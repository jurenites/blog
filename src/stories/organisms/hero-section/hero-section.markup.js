...
export function hero_section_markup({ section_label, eyebrow_heading, background_image_url, image_description, glow_enabled, hero_slides }) {
  ...
  return render_template(hero_template, {
    ...
    scene_markup: background_image_url
      ? `<div class="hero-section__scene"><div class="hero-section__photo-plane"><img class="hero-section__image" src="${escape_html(background_image_url)}" alt="${escape_html(image_description)}" decoding="async"><div class="hero-section__glow" aria-hidden="true"><div class="hero-section__rays"><div class="hero-section__light-color"><span class="hero-section__beam"></span><span class="hero-section__beam"></span></div></div></div></div><button class="hero-section__light-toggle" type="button" aria-pressed="false" hidden>Screen light</button></div>` : "",
