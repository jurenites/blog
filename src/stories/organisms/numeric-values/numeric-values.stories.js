...
const TRACKED_NUMBER = "~10 000h";
const TRACKED_DESCRIPTION = "As a Web Developer role";
const TRACKED_CAPTION = "*tracked with";
const TRACKED_DOMAIN = "redmine.org";
const TRACKED_URL = "https://redmine.org";
    ...
    numeric_items: [
      {
        ...
        numeric_caption: story_args.project_caption,
        numeric_caption_link_label: story_args.project_caption_link_label,
        numeric_caption_link_url: story_args.project_caption_link_url,
...
export default {
  ...
  parameters: {
    docs: {
      description: {
        component: "A Home-page-ready list of up to eight statistic tiles, with no more than four per row. Each tile pairs an optional attached SVG, an authored 64px h2 Number, subtitle-1 Text, an optional gray caption with an underlined domain link, and an optional labeled link; long grouped values use the compact number-size token so affixes remain inside the tile. When a tile enters the viewport, its integer rolls once from zero to the authored value with a short, decelerating drum motion; reduced-motion visitors see the final value immediately. Attached artwork keeps its intrinsic dimensions and aspect ratio, with an 80px maximum width.",
      },
    },
  },
  argTypes: {
    ...
    project_caption: { control: "text" },
    project_caption_link_label: { control: "text" },
    project_caption_link_url: { control: "text" },
  ...
  args: {
    ...
    project_caption: "",
    project_caption_link_label: "",
    project_caption_link_url: "",
...
export const tracked_caption_story = {
  args: {
    project_number: TRACKED_NUMBER,
    project_description: TRACKED_DESCRIPTION,
    project_caption: TRACKED_CAPTION,
    project_caption_link_label: TRACKED_DOMAIN,
    project_caption_link_url: TRACKED_URL,
    project_link_url: "",
  },
};
