...
export function life_example_markup({ column_count = 6, row_count = 6, zoom_size = 4, living_cells = [], example_description = 'Game of Life example. Move the pointer to draw live cells. Reload to restore the pattern.' } = {}) {
