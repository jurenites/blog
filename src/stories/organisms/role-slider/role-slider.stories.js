...
const ROLE_ITEMS = [
  { numeric_number: '~10 000h', role_heading: 'Web developer', numeric_caption: '*tracked with', numeric_caption_link_label: 'redmine.org', numeric_caption_link_url: 'https://redmine.org', story_text: 'Your web development story goes here.' },
  { numeric_number: '~10 000h', role_heading: 'Project manager & product owner', story_text: 'Your project management and product ownership story goes here.' },
  { numeric_number: '~8 000h', role_heading: 'Business analyst & UI/UX designer', story_text: 'Your business analysis and design story goes here.' },
];
const METRIC_ITEMS = [
