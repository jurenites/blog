...
//
// Reason: src/token/tokens.yaml is the source of truth; this file is a derived transport
...
const OUTPUT = resolve(ROOT, 'generated/tokens/tokens.studio.json');
...
async function main() {
  ...
  console.log('In Figma: Tokens Studio -> Settings -> Sync -> point at generated/tokens/tokens.studio.json, then Pull.');
}
