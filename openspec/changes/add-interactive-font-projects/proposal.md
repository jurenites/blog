...
- Add a reusable font-preview section that loads a selected local font, presents a live “Try it yourself” text input and pangram, and renders only glyphs with Unicode mappings in a responsive full-width grid of 40px minimum tiles.
