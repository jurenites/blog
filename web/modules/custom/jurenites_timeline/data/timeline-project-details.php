...
/**
 * @file
 * Project descriptions and proof links transcribed from the linked CV.
 */
...
return [
  ...
  'Funneleyes Web App' => [
    'summary' => 'Worked as UI/UX designer and prepared a new interface for an internal project-management system similar to Jira.',
  ],
  'Vincofy' => [
  ...
  'JOacademy' => [
    'summary' => 'Worked as UI/UX designer on an online-learning platform.',
  ],
  'Visuals2Go' => [
  ...
  'Genlocker / Finch' => [
    'summary' => 'Worked as Product Owner on a gene-screening and pedigree-data management system.',
  ],
  'Enfusen' => [
  ...
  'Precision' => [
    'summary' => 'Worked as Project Manager, designed the database structure, prepared the development backlog, and delivered an MVP mobile app that used a pole-mounted camera and backend API to detect how much food remained in a cattle bunk.',
    'proofs' => [
      ['title' => 'Database schema', 'url' => 'https://app.moqups.com/bL0eveLoez/view/page/a8d901e4f'],
    ],
  ],
  'Nokia' => [
  ...
  'Greenback' => [
    'summary' => 'Worked as Project Manager and recorded proof-of-concept demonstrations for an AI conveyor-belt waste detector and a token-based ecosystem for plastic-production quotas.',
    'proofs' => [
      ['title' => 'Wireframes', 'url' => 'https://app.moqups.com/ASDCqx08e0/view'],
    ],
  ],
  ...
  'GamerSpeak App' => [
    'summary' => 'Prepared the mobile-application wireframe.',
    'proofs' => [
      ['title' => 'Wireframe', 'url' => 'https://app.moqups.com/W31HFAzkHY/view/page/a7a6d17c2'],
    ],
  ],
  ...
  'National Community Church Request form' => [
    'summary' => 'Created mockups from customer documents, approved pages, assigned developers, wrote tasks, reviewed results, and demonstrated the delivered project to the customer.',
  ],
  'ArkivMusic Naxos' => [
  ...
  'Zoolu' => [
    'summary' => 'Prepared documentation for a cargo supply-chain project using smart contracts.',
    'proofs' => [
      ['title' => 'Wireframe PDF', 'url' => 'https://www.dropbox.com/s/bc4r6qk7t2kscmo/Zoolu.pdf?dl=0'],
    ],
  ],
  'Care & Prayer' => [
    'summary' => 'Worked as Product Owner and Project Manager, created developer wireframes and a backlog for a CMS that stores and fulfils user requests.',
    'proofs' => [
      ['title' => 'Wireframe PDF', 'url' => 'https://www.dropbox.com/s/p8o1281p0zjwlgj/Care_Prayer.pdf?dl=0'],
    ],
  ],
  'Digital Content' => [
    'summary' => 'Prepared the project wireframe.',
    'proofs' => [
      ['title' => 'Wireframe PDF', 'url' => 'https://www.dropbox.com/s/un4mcacqzla3lue/DigintalContent.pdf?dl=0'],
    ],
  ],
  ...
  'NeedsApp' => [
    'summary' => 'Worked as Project Manager and Product Owner and prepared the project wireframe.',
    'proofs' => [
      ['title' => 'Wireframe PDF', 'url' => 'https://www.dropbox.com/s/6y6suhkxh2auhyn/Needs_App.pdf?dl=0'],
    ],
  ],
  'HubPlay Trivia' => [
    'summary' => 'Worked as Project Manager, translated customer requests into daily development tasks, and coordinated an iOS trivia app used while watching live games plus its administration website.',
    'proofs' => [
      ['title' => 'Mobile-app wireframe PDF', 'url' => 'https://www.dropbox.com/s/k7o39ca2hoohofs/Trivia_Hubsplay_App.pdf?dl=0'],
      ['title' => 'Admin-panel wireframe PDF', 'url' => 'https://www.dropbox.com/s/bxlieuf2cbmtnjc/HuB_Play_Web_App.pdf?dl=0'],
      ['title' => 'Project profile', 'url' => 'https://www.f6s.com/hubplay/'],
    ],
  ],
  ...
  'Internal NDA project' => [
    'summary' => 'Worked on an internal company project protected by a non-disclosure agreement.',
  ],
  'Kidsvolunteer' => [
  ...
  'Life Church Blackbriar' => [
    'summary' => 'Worked as Project Manager and Product Owner, maintained documentation and Scrum coordination for a system that tracked and visualised donation money flows across cash, cheque, and credit-card sources.',
  ],
  ...
  'Oysterlabs Games Server' => [
    'summary' => 'Worked as PHP developer in a large Symfony 2 team, created REST APIs for mobile apps, and contributed to the initial database schema.',
  ],
  'Oysterlabs Mail System' => [
    'summary' => 'Worked as PHP developer on an internal system that sent email notifications in response to website status events.',
  ],
  'OK State Fair' => [
  ...
  'Chevy Music Showcase' => [
    'summary' => 'Worked as developer on a Drupal 6 site and connected its blog with a Facebook feed using contributed modules.',
    'proofs' => [
      ['title' => 'Chevy Music OKC on Facebook', 'url' => 'https://www.facebook.com/ChevyMusicOKC/'],
    ],
  ],
  'Automobile Alley' => [
  ...
  'Basin Energy' => [
    'summary' => 'Worked as PHP developer on a Drupal 6 information website.',
  ],
  ...
  'EMB' => [
    'summary' => 'Worked as PHP developer and applied supplied HTML slices to Drupal information-site templates.',
  ],
  'HIPAA Security Assessment Toolkit' => [
    'summary' => 'Worked as PHP developer on the MVC structure of a healthcare security-assessment toolkit.',
  ],
];
