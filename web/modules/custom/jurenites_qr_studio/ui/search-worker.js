...
self.onmessage=async({data:search_options})=>{
  ...
  try{
    ...
    for(let search_index=0;alpha_only&&search_index<search_patterns.length&&performance.now()<solver_deadline;search_index++){
